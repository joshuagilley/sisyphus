declare global {
  ...
  const getProblemBySlug: typeof import('../../server/utils/problems').getProblemBySlug
  const getProblems: typeof import('../../server/utils/problems').getProblems
  const getProgressBySlug: typeof import('../../server/utils/progress').getProgressBySlug
  const getProgressEntries: typeof import('../../server/utils/progress').getProgressEntries
  ...
  const runSolution: typeof import('../../server/utils/runner').runSolution
  ...
  const upsertProgress: typeof import('../../server/utils/progress').upsertProgress
...
declare global {
  // @ts-ignore
  export type { Problem, TestResult, ProgressEntry } from '../../server/utils/types'
